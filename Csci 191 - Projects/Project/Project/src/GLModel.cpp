...
=======
void Model::ballUpdateHbox(float CurXpos, float CurYpos)//updates the hitbox location to the players location
 {
=======
void Model::ballUpdateHbox(float CurXpos, float CurYpos)//updates the hitbox location to the players location
 {
...
>>>>>>> parent of 4db99ef... Merge branch 'master' of https://github.com/RAGE778/SnackBoys
    //cout<<"callled"<<endl;
    this->ballHBox.x=CurXpos;//(this->verticies[0].x+this->verticies[1].x)/2;
    this->ballHBox.y=CurYpos;//(this->verticies[1].y+this->verticies[2].y)/2;
    //cout<<this->ballHBox.x<<", "<<this->ballHBox.y<<endl;
>>>>>>> parent of 4db99ef... Merge branch 'master' of https://github.com/RAGE778/SnackBoys
